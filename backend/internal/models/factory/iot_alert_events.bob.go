...
import (
	...
	models "iiot_system/backend/internal/models"
)
...
type IotAlertEventTemplate struct {
	...
	Message      func() string
	CurrentValue func() sql.Null[decimal.Decimal]
...
// Set the model columns to this value
func (m iotAlertEventMods) CurrentValue(val sql.Null[decimal.Decimal]) IotAlertEventMod {
	return IotAlertEventModFunc(func(_ context.Context, o *IotAlertEventTemplate) {
		o.CurrentValue = func() sql.Null[decimal.Decimal] { return val }
	})
}

// Set the Column from the function
func (m iotAlertEventMods) CurrentValueFunc(f func() sql.Null[decimal.Decimal]) IotAlertEventMod {
	return IotAlertEventModFunc(func(_ context.Context, o *IotAlertEventTemplate) {
		o.CurrentValue = f
	})
}
...
func (m iotAlertEventMods) RandomCurrentValue(f *faker.Faker) IotAlertEventMod {
	return IotAlertEventModFunc(func(_ context.Context, o *IotAlertEventTemplate) {
		o.CurrentValue = func() sql.Null[decimal.Decimal] {
			if f == nil {
				f = &defaultFaker
			}

			val := random_decimal_Decimal(f, "6", "2")
			return sql.Null[decimal.Decimal]{V: val, Valid: f.Bool()}
		}
	})
}
...
func (m iotAlertEventMods) RandomCurrentValueNotNull(f *faker.Faker) IotAlertEventMod {
	return IotAlertEventModFunc(func(_ context.Context, o *IotAlertEventTemplate) {
		o.CurrentValue = func() sql.Null[decimal.Decimal] {
			...
			val := random_decimal_Decimal(f, "6", "2")
			return sql.Null[decimal.Decimal]{V: val, Valid: true}
		}
	})
}
