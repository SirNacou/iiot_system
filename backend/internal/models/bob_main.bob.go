...
var TableNames = struct {
	IotAlertEvents   string
	SchemaMigrations string
}{
	IotAlertEvents:   "iot_alert_events",
	SchemaMigrations: "schema_migrations",
}

var ColumnNames = struct {
	IotAlertEvents   iotAlertEventColumnNames
...
func Where[Q psql.Filterable]() struct {
	...
	return struct {
		...
		IotAlertEvents:   buildIotAlertEventWhere[Q](IotAlertEventColumns),
